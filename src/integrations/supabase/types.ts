...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      children: {
        Row: {
          ...
          organization_id: string
          privacy_restriction:
            | Database["public"]["Enums"]["privacy_preference_type"]
            | null
      ...
      training_step_events: {
        Row: {
          ...
          organization_member_id: string
          result:
            | Database["public"]["Enums"]["training_step_event_result"]
            | null
          step_key: string
    ...
    Functions: {
      ...
      clear_training_catalogue_actor_context: {
        Args: never
        Returns: undefined
      }
      clear_training_gate_actor_context: { Args: never; Returns: undefined }
