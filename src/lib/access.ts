...
export const permissions: Record<Action, { label: string; roles: AppRole[] }> = {
  ...
  "bookings.finance": { label: "Change money fields (price, advance, payment)", roles: ["accounts", "sales"] },
  "pipeline.advance": { label: "Advance a family's journey stage", roles: ["coordinator"] },
  "memory.write": { label: "Write memory profiles", roles: ["coordinator", "sales", "photographer"] },
  "safety.write": { label: "Complete safety & comfort checklists", roles: ["coordinator", "photographer", "assistant"] },
  ...
  "tasks.write": { label: "Create and close team tasks", roles: [
    "coordinator",
    "sales",
    "photographer",
    "assistant",
  ...
  "reviews.write": { label: "Request reviews and log aftercare", roles: ["coordinator", "marketing"] },
